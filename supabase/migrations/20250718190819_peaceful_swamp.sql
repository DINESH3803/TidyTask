/*
  # Fix Authentication Schema - Create Profiles Table
  ...
  1. New Tables
    ...
    - `tasks` - User tasks (updated to reference auth.users directly)
      - `id` (uuid, primary key)
...
-- Create tasks table (if it doesn't exist or recreate with correct structure)
